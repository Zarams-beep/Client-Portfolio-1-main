...
export const projects = [
  ...
  type: "python",
  description:
    "Built a machine learning model in Python to predict customer churn using logistic regression and decision trees. The project involved data preprocessing, feature engineering, and model evaluation for actionable business insights.",
  image: ImageCollection.pandas,
  githubRepo: "#",
},
  ];
  ...
  export const projectTypes = ["sql", "R", "power bi", "excel", "python"];
  ...
  export const PPTS = [
    ...
    {
  src: ImageCollection.python,
  project: "Python",
  detail:
    "Leveraged Python for data cleaning, analysis, and automation using libraries like Pandas, NumPy, and Matplotlib to drive data-driven decisions and streamline workflows.",
  link: "#",
},
  ];